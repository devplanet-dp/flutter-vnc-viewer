...
Java_com_libvncserver_flutter_libvncviewer_1flutter_VncClient_rfbInitClient(JNIEnv *env,
                                                                            jobject thiz,
                                                                            jstring host_name,
                                                                            jint port,
                                                                            jstring password,
...
Java_com_libvncserver_flutter_libvncviewer_1flutter_VncClient_startRfbClient(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jlong client_id) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_libvncserver_flutter_libvncviewer_1flutter_VncClient_sendPointer(JNIEnv *env, jobject thiz,
